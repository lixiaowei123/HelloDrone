...
public class MainActivity extends ActionBarActivity implements DroneListener, TowerListener, LinkListener {
    private static final String TAG = MainActivity.class.getSimpleName();
    private static final String MAGTAG="LXW";
    private Drone drone;
    ...
    //默认usb的波特率
    private static final int DEFAULT_USB_BAUD_RATE = 115200;
    ...
    protected void updateSpeed() {
        ...
        Log.i("lxw","speed:"+droneSpeed.getGroundSpeed());
